...
from widgets.bottom_input_area import (
    SendableTextEdit,
)
from widgets.context_selector import (
    ContextSelector,
)
from widgets.conversation_node_preview import (
    ConversationNodePreview,
)
from widgets.llm_config_popup import (
    LLMConfigPopup,
)
from widgets.memory_manager import (
    MemoryManagerDialog,
)
from widgets.message_card import (
    MessageCard,
    create_welcome_card,
)
from widgets.question_floating_widget import (
...
from widgets.todo_floating_widget import (
    TodoFloatingWidget,
)
from widgets.sub_agent_floating_widget import (
    SubAgentFloatingWidget,
)
from widgets.tool_floating_widget import (
    ToolFloatingWidget,
)
...
class OpenAIChatToolWindow(ToolWindow):
    ...
    def _initialize_managers(self):
        ...
        from core.sub_agent_executor import (
            SubAgentManager,
        )
